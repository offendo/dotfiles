...
(defun nilays-set-display ()
  ;; fonts
  (set-face-attribute 'variable-pitch nil :font "Source Code Pro Medium-13")
  (set-face-attribute 'fixed-pitch nil :font "Source Code Pro Medium-12")
