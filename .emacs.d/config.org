...
(setq backupdir (concat nilays-cache-dir "backup/"))
...
** Frame Hook
#+begin_src elisp
(defun nilays-appearance-setup (frame)
  (with-selected-frame frame
    (remove-hook 'after-make-frame-functions 'nilay-appearance-setup)
...
(if (daemonp)
    (add-hook 'after-make-frame-functions 'nilays-appearance-setup)
  (nilays-appearance-setup (car (frame-list))))
#+end_src
